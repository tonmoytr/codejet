        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-2">
          <div className="flex justify-center items-center gap-6">
            <div
              ...
              style={{ backgroundImage: "url('/assets/backgrounds/2.png')" }}
            ></div>
          </div>
          <div className="px-[48px] py-[30px] mt-10 md:mt-0">
            ...
            <div className="flex flex-col md:flex-row items-start gap-4 mt-8">
              ...
              {/* <button className="px-8 py-3 rounded-xl bg-gray-100 hover:bg-gray-200 text-lg font-bold hover:text-orange-500">
                Explore Templates
              </button> */}
            </div>
          </div>
